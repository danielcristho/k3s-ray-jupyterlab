...
sudo wget -O /var/tmp/images/base.qcow2 ${var.ubuntu_22_img_url}
sudo chown libvirt-qemu:kvm /var/tmp/images/base.qcow2
sudo chmod 644 /var/tmp/images/base.qcow2
EOT
  }
}
...
resource "libvirt_volume" "base" {
  name       = "base.qcow2"
  source     = "/var/tmp/images/base.qcow2"
  pool       = "testpool"
  format     = "qcow2"
